describe('cipher', () => {
  ...
  describe('cipher.encode', () => {
    ...
    it('debería retornar "/012345678" para "0123456789"  con offset 30',() => {
      assert.equal(cipher.encode(30,"0123456789"),"/012345678");
    });
  ...
  describe('cipher.decode', () => {
    ...
    it('debería retornar "ÐÑÒÓÔÕÖ×ØÙÚÍÎÏ" para "ÒÓÔÕÖ×ØÙÚÍÎÏÐÑ" con offset 30',() => {
      assert.equal(cipher.decode(30,"ÒÓÔÕÖ×ØÙÚÍÎÏÐÑ"),"ÐÑÒÓÔÕÖ×ØÙÚÍÎÏ");
    });
